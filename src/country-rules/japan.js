...
- **免税**：日本的免税制度在 **2026年11月1日** 換過一次，
  ...
  **判準只有一條：看收據上的消費税是不是 0。**
  ...
  | 有正常的 8% / 10% 消費税金額 ＋ 免税／リファンド 字樣 | **新制**（2026-11-01～） | 店裡照付含稅價。\`total\` = 含稅合計。待退稅額填 \`taxRefundPending\` |
...
\`現金\`、\`交通系マネー\`、\`交通系マネー支払\`、\`Suica支払\`、\`クレジット\` 後面那個數字。
**有印就照抄那個數字**，不要自己算。
